...
public class SupplierQuotationDTO {
    ...
    public int getGroupSameItems() { return groupSameItems;}
    public void setGroupSameItems(int groupSameItems) { this.groupSameItems = groupSameItems;}

    public String getLanguage() { return language;}
    public void setLanguage(String language) { this.language = language;}

    public int getIsSubcontracted() { return isSubcontracted;}
    public void setIsSubcontracted(int isSubcontracted) { this.isSubcontracted = isSubcontracted;}
